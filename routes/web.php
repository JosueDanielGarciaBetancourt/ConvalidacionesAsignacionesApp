...
Route::post('/inicia-sesion', [LoginController::class,'login'])->name('inicia-sesion')->middleware('web');
Route::post('/logout', [LoginController::class,'logout'])->name('logout');


// Rutas para página de inicio
Route::prefix('pagina-inicio')->middleware('auth')->group(function () {
    Route::get('/', [PaginaInicioController::class, 'convalidarCursos'])->name('pagina-inicio.convalidar-cursos');
...
Route::post('/pagina-inicio/postulantes-registrar/store', [RegistroPostulanteController::class, 'store'])->name('pagina-inicio.postulantes-registrar.store');
/*
